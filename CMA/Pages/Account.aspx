                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="acc_profileEmail" value="john.doe@buildright.com">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="acc_profileAddress" rows="1">123 Construction Ave, Building City</textarea>
                                    </div>
                                </div>
