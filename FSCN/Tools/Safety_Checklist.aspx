...
<%@ Page Title="Safety_Checklist" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Safety_Checklist.aspx.cs" Inherits="FSCN.Tools.Safety_Checklist" %>
                ...
                <div class="modal-body">
                    <form id="checklist-form">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="checklist-site" required placeholder="e.g., 123 Main St Construction Site">
                        </div>
                        <div class="mb-3">
