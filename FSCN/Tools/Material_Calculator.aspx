<%@ Page Title="Material Calculator" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Material_Calculator.aspx.cs" Inherits="FSCN.Tools.Material_Calculator" %>
        ...
        <section class="py-5 filter-row-button-section ">
            <div class="container">
                 <div class="tool-nav mb-3 d-flex gap-3">
                    <a href="/Tools/Material_Calculator" class="active btn btn-outline-primary"><i class="fas fa-calculator"></i>Material Calculator</a>
                    <a href="/Tools/Roof_Calculator" class="btn btn-outline-secondary"><i class="fas fa-home"></i>Roof Calculator</a>
                    <a href="/Tools/Floor_Planner" class="btn btn-outline-secondary"><i class="fas fa-ruler-combined"></i>Floor Planner</a>
                    <a href="/Tools/Unit_Convertor" class="btn btn-outline-secondary"><i class="fas fa-exchange-alt"></i>Unit Converter</a>
                </div>
            </div>
        </section>
