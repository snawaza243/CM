...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="content">
        <section id="floor-planner-section" class="section d-block ">
            <!-- Page Hero Section -->
            <section class="page-hero">
                <div class="container text-center">
                    <h2 class="mb-5 text-center"><i class="fas fa-vector-square me-2"></i>Floor Plan Creator</h2>
            ...
            <section class="tool-info-mobile py-4 d-block d-lg-none text-center">
                <div class="container">
                    <div class="card glass mx-auto" style="max-width: 500px;">
                        <div class="card-body">
                            <i class="bi bi-info-circle fs-2 text-warning mb-3"></i>
                            <h5 class="fw-bold">Feature Unavailable on Mobile</h5>
                            <p class="text-muted mb-0">
                                This design feature is available only on larger screens.<br>
            ...
            <section class="tool-container py-4 d-none d-lg-block">
                <div class="container glass">
                    <div class="planner-wrapper">
                        <div class="planner-controls">
                            ...
                            <div class="control-group">
                                ...
                                <button id="btnHome" class="btn-control btn btn-outline-success"><i class="bi bi-home"></i>Home</button>
                    ...
                    <hr />
                    <div class="card-body service-card text-center">
                        <div class="d-flex align-items-center justify-content-center mb-3">
                            <div class="card-icon me-3">
                                <i class="bi bi-cloud-arrow-down fs-3 text-primary"></i>
                            </div>
                            <h4 class="mb-0">Export Your Design</h4>
                        </div>

                        <div class="export-options d-flex flex-wrap justify-content-center gap-3 mb-3">
                            <button id="btnExportImage" class="btn btn-primary">
                                <i class="bi bi-image me-1"></i>Save as Image
                            </button>
                        ...
                        <div class="export-note mt-3">
                            <p class="text-muted mb-0">
                                ...
                                For professional construction plans, contact our design team.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card glass h-100">
                                <div class="card-body service-card">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        <li>Doors: 3' wide, 7' tall</li>
                                        <li>Hallways: Minimum 3' wide</li>
                                        <li>Kitchen work triangle: 12'-26' total</li>
                                        <li>Staircases: Minimum 3' wide</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card glass h-100">
                                <div class="card-body service-card">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <h4>Standard Design Principles</h4>
                                    </div>
                                    <ul class="list-unstyled mb-0">
                                        <li>Group rooms by function</li>
                                        <li>Consider natural light sources</li>
                                        <li>Plan furniture placement early</li>
                                        <li>Allow for proper circulation</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card glass h-100">
                                <div class="card-body service-card">
                                    <div class="d-flex align-items-center mb-3">
                                        ...
                                        <h4>Village Considerations</h4>
                                    </div>
                                    <ul class="list-unstyled mb-0">
                                        <li>Traditional architectural styles</li>
                                        <li>Local climate adaptations</li>
                                        <li>Family gathering spaces</li>
                                        <li>Outdoor connections</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
