...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="content">
        ...
        <section id="material-calculator" class="section d-block ">

            <!-- Page Hero Section -->
            <section class="page-hero">
                <div class="container text-center">
                    <h2 class="mb-5 text-center">Construction Material Calculator</h2>
            ...
            <section class="ctm-tab-btn">
                <div class="container text-center">
                    <div class="calculator-tabs btn-group mb-4" role="group" aria-label="Calculator tabs">
                        <button type="button" class="tab-btn btn btn-primary" data-tab="brick">Brick Wall</button>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-10">
                            <div class="card glass">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="calculator-content p-4 p-md-5">

                                            <!-- Brick Calculator -->
                                            <div class="tab-pane active" id="brick">
                                                <div class="text-center mb-5">
                                                    <h2 class="fw-bold section-title">Brick Wall Calculator</h2>
                                                ...
                                                <div id="brickCalculator" class="mb-4">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-4 custom-size d-none" id="customSizeGroup">
                                            ...
                                            <div class="tab-pane d-none" id="concrete">
                                                <div class="text-center mb-5">
                                                    <h2 class="fw-bold section-title">Concrete Calculator</h2>
                                                    <p class="lead">Building your dream home from the ground up</p>
                                                </div>
                                            ...
                                            <div class="tab-pane d-none" id="plaster">
                                                <div class="text-center mb-5">
                                                    <h2 class="fw-bold section-title">Plaster Calculator</h2>
                                                    <p class="lead">Building your dream home from the ground up</p>
                                                </div>
                                            ...
                                            <div class="tab-pane d-none" id="paint">
                                                <div class="text-center mb-5">
                                                    <h2 class="fw-bold section-title">Paint Calculator</h2>
                                                    <p class="lead">Building your dream home from the ground up</p>
                                                </div>
            ...
            <section class="tool-info py-4">
                <div class="container">
                    <h3 class="mb-3">How to Use This Calculator</h3>
                    <div class="row g-4">
                        <!-- Step 1 -->
                        <div class="col-md-4">
                            <div class="card glass h-100 text-center hover-card">
                                <div class="card-body p-4">
                                    <div class="card-icon fs-1 text-primary mb-3">
                                        <i class="fas fa-ruler"></i>
                                    </div>
                                    <h4 class="mb-2">Take Measurements</h4>
                                    <p>Measure the length and height of your wall in meters using a tape measure for accurate calculation.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card glass h-100 text-center hover-card">
                                <div class="card-body p-4">
                                    <div class="card-icon fs-1 text-success mb-3">
                                        <i class="fas fa-edit"></i>
                                    </div>
                                    <h4 class="mb-2">Enter Details</h4>
                                    <p>Fill in your wall dimensions and choose the brick type and wall thickness to proceed.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card glass h-100 text-center hover-card">
                                <div class="card-body p-4">
                                    <div class="card-icon fs-1 text-warning mb-3">
                                        <i class="fas fa-calculator"></i>
                                    </div>
                                    <h4 class="mb-2">Get Results</h4>
                                    <p>View an instant estimate of bricks, cement, and sand required for your construction project.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-5">
                        <div class="note-box">
                            <div class="note-icon">
                                <i title="Disclaimer" class="fas fa-exclamation-triangle"></i>
                            </div>
                            <div class="note-content">
                                <h5>Note</h5>

                                <p class="mb-0">This calculator provides estimates only. For precise requirements, consult with our construction experts. Material costs may vary based on market conditions and your specific location in the village.</p>
